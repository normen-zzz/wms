...
class Log_model extends CI_Model
{
	...
	{
		$this->db->select('wms_log.id_log,wms_log.at, barang.sku, batch.batchnumber, rack.sloc,batch.expiration_date, wms_log.qty, wms_log.condition,barang.nama_barang, wms_log.no_document');
