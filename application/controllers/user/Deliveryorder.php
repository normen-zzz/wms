...
class Deliveryorder extends CI_Controller
{
    ...
    public function printDeliveryOrder($uuidDeliveryorder)
    {
        ...
        $mpdf = new \Mpdf\Mpdf(['mode' => 'utf-8', 'format' => 'A4', 'margin_left' => 15, 'margin_right' => 15, 'margin_top' => 16, 'margin_bottom' => 16, 'margin_header' => 9, 'margin_footer' => 9]);
        ...
        $html .= '<table style="width: 100%"><tr><th>No</th><th>SKU</th><th>Nama Barang</th><th>Batch</th><th>Expiration Date</th><th>Qty</th></tr>';
        ...
        foreach ($deliveryorderItems->result() as $item) {
            ...
            if ($itemCount >= 20) { // adjust this value to control the number of items per page
        ...
        <p class="center" ><b> ' . $totalitem . ' Delivery Order : ' . $deliveryorder['ext_deliveryorder'] . '</b></p>
        <table style="width: 100%; border-collapse: collapse; border: none;">
            ...
            <tr>
                ...
                $html .= '<table style="width: 100%"><tr><th>No</th><th>SKU</th><th>Nama Barang</th><th>Batch</th><th>Expiration Date</th><th>Qty</th></tr>'; // Add a new table header
        ...
        $html .= '<table id="tandatangan" style="width: 40%; margin-right: 0; margin-left: auto; border-collapse: collapse; border: none; margin-top: 10px;"  keep-row-together="true">';
        $html .= '<tr>';
        $html .= '<td style="width: 50%; height:80px; text-align: center; "></td>';
