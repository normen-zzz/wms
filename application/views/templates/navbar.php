<nav class="main-navbar">
    <div class="container">
        ...
        <ul>
                    ...
                    <div class="submenu-group-wrapper">
                        ...
                        <ul class="submenu-group">
                            ...
                            <li class="submenu-item  has-sub">
                                ...
                                <ul class="subsubmenu">
                                    <li class="subsubmenu-item ">
                                        <a href="<?= base_url('user/Picklist/addPicklist') ?>" class="subsubmenu-link">Add Picklist</a>
                                    </li>
                            ...
                            <li class="submenu-item  has-sub">
                                ...
                                <ul class="subsubmenu">
                                    <li class="subsubmenu-item ">
                                        <a href="<?= base_url('user/Receiving/addReceivingInbound') ?>" class="subsubmenu-link">Add Receiving inbound</a>
                                    </li>

                                    <li class="subsubmenu-item ">
                                        <a href="<?= base_url('user/Receiving/dataReceivingInbound') ?>" class="subsubmenu-link">Data Receiving Inbound</a>
                                    </li>
                                </ul>
            ...
            <li class="menu-item  ">
                <a href="<?= base_url('user/Inventory') ?>" class='menu-link'>
                    ...
                    <div class="submenu-group-wrapper">
                        ...
                        <ul class="submenu-group">
                            ...
                            <li class="submenu-item  has-sub">
                                ...
                                <ul class="subsubmenu">
                                    <li class="subsubmenu-item ">
                                        <a href="<?= base_url('user/Goodsorder/addGoodsOrder') ?>" class="subsubmenu-link">Add Goods Order</a>
                                    </li>

                                    <li class="subsubmenu-item ">
                                        <a href="<?= base_url('user/Goodsorder/dataGoodsOrder') ?>" class="subsubmenu-link">Data Goods Order</a>
                                    </li>
                            ...
                            <li class="submenu-item  has-sub">
                                ...
                                <ul class="subsubmenu">
                                    <li class="subsubmenu-item ">
                                        <a href="<?= base_url('user/Pickingslip/addPickingSlip') ?>" class="subsubmenu-link">Add Picking Slip</a>
                                    </li>

                                    <li class="subsubmenu-item ">
                                        <a href="<?= base_url('user/Pickingslip/dataPickingSlip') ?>" class="subsubmenu-link">Data Picking Slip</a>
                                    </li>
                            ...
                            <li class="submenu-item  has-sub">
                                ...
                                <ul class="subsubmenu">
                                    <li class="subsubmenu-item ">
                                        <a href="<?= base_url('user/Packing/addPacking') ?>" class="subsubmenu-link">Add Packing</a>
                                    </li>

                                    <li class="subsubmenu-item ">
                                        <a href="<?= base_url('user/Packing/dataPacking') ?>" class="subsubmenu-link">Data Packing</a>
                                    </li>
                            ...
                            <li class="submenu-item  has-sub">
                                ...
                                <ul class="subsubmenu">
                                    <li class="subsubmenu-item ">
                                        <a href="<?= base_url('user/Deliveryorder/addDo') ?>" class="subsubmenu-link">Add DO</a>
                                    </li>

                                    <li class="subsubmenu-item ">
                                        <a href="<?= base_url('user/Deliveryorder/dataDo') ?>" class="subsubmenu-link">Data DO</a>
                                    </li>
