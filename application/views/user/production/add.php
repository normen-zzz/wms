											...
											<div class="form-group mb-3">
												...
												<select id="sku_bundling" class="form-control select-sku-bundling">
													...
													<?php foreach ($sku_bundling->result() as $row): ?>
														<option value="<?= $row->sku ?>"><?= $row->sku ?> ||
															<?= $row->nama_barang ?></option>
													<?php endforeach; ?>
												</select>
												<label for="batch_bundling">Batch Bundling</label>
												<input type="text" class="form-control" id="batch_bundling"
													name="batch_bundling" placeholder="Batch Bundling">
												<!-- quantity  -->
												<label for="quantity_bundling">Quantity</label>
												<input type="number" class="form-control" id="quantity_bundling"
													name="quantity_bundling" placeholder="Quantity">

												<!-- ed_bundling -->
												<label for="ed_bundling">Expired Date</label>
												<input type="date" class="form-control" id="ed_bundling"
													name="ed_bundling" placeholder="Expired Date">


												<button type="button" id="search-bundling"
