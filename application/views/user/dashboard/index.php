                                        ...
                                        <div class="card-body px-4 py-4-5">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                                    ...
                                                    <h6 class="font-extrabold mb-0"> <?= $total_rack_items ?></h6>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
								...
								<div class="col-lg-12">
									<div class="card">
										<div class="card-header">
											<h4>Barang Masuk per Bulan</h4>
										</div>
										<div class="card-body">
											<div id="chart-incoming-items"></div>
										</div>
									</div>
								</div>
								<div class="col-lg-12">
									<div class="card">
										<div class="card-header">
											<h4>Barang Keluar per Bulan</h4>
										</div>
										<div class="card-body">
											<div id="chart-outgoing-items"></div>
										</div>
									</div>
								</div>
							</div>
